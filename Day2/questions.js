...
let guestList = ["Harshal", "Prachi", "Varsha", "Anushl"];
...
const price = ["100", "250", "75", "50", "20"]; 
const removedItem = price.splice(-1, 1);
const numericPrices = price.map(price => Number(price));
